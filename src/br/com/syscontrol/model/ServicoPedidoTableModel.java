 ...
 * @author Diego
 */
public class ServicoPedidoTableModel extends AbstractTableModel implements TableModelListener{
    ...
    public ServicoPedidoTableModel(){
        this.linhas = new ArrayList<ItemPedido>();
    }

    public ServicoPedidoTableModel(List<ItemPedido> listaItens){
